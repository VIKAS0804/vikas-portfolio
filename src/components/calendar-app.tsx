...
export default function CalendarApp({ windowId }: { windowId: string }) {
  return (
    <Window windowId={windowId} windowTitle="Calendar Application">
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            ...
            <div className="flex items-center gap-3 border-b-2 border-gray-400 pb-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">
                  Google Calendar-style desktop app with GUI/CLI/headless interfaces
                </p>
              </div>
            </div>
            ...
            <div className="border-2 border-gray-400 bg-[#f0f0f0] p-3 shadow-inner">
              ...
              <p className="text-xs text-gray-700 leading-relaxed">
                Google Calendar-style desktop app with GUI/CLI/headless interfaces.
                Supports recurring events, conflict detection (O(log n) using interval
                trees), timezone normalization. 90%+ test coverage with TDD.
              </p>
            </div>
            ...
            <div className="border-2 border-gray-400 bg-[#f0f0f0] p-3 shadow-inner">
              ...
              <div className="space-y-2 text-xs text-gray-700">
                <div className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Single/recurring/multi-day events</strong> support
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-blue-600 font-bold">•</span>
                  <span>
                    <strong>O(log n) conflict detection</strong> using interval trees
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-blue-600 font-bold">•</span>
                  <span>
                    <strong>CSV/ICS import/export</strong> functionality
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-blue-600 font-bold">•</span>
                  <span>
                    <strong>&lt;100ms month-view refresh</strong> performance
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-blue-600 font-bold">•</span>
                  <span>
                    <strong>Timezone normalization</strong> support
                  </span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-blue-600 font-bold">•</span>
                  <span>
                    <strong>90%+ test coverage</strong> with TDD approach
                  </span>
                </div>
              </div>
            </div>
